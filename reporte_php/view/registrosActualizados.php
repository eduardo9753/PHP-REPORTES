                        ...
                        <div class="card-body">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($this->MODEL->registroPersonalActualizado() as $data) : ?>
                                        <tr>
                                            ...
                                            <td> <a href="index.php?ruta=reporte&id=<?php echo $data->idDNI; ?>" class="btn btn-warning" target="_blank">Ver Reporte</a></td>
                                        </tr>
                                    <?php endforeach; ?>
